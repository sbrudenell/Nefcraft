                        ...
                        BuildingType[ent] == TFExtObject_Amplifier)
                    {
                        ...
                        switch (Condition)
                        {
                            ...
                            case TFCond_Slowed, TFCond_Zoomed, TFCond_TeleportedGlow, TFCond_Taunting,
                                 ...
                                 TFCond_Disguised, TFCond_Cloaked, TFCond_Bleeding, TFCond_Milked:
                            {
...
RemoveRepairParticles(obj)
{
    ...
    {
        new particle = RepairNodeParticle[obj][i];
        if (particle != 0)
        {
            DeleteParticle(particle);
            RepairNodeParticle[obj][i] = 0;
        }
    }
}
